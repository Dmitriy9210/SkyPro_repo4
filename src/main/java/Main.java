public class Main {
    ...
    public static void main(String[] args) {
        ...
        age = 14;
        if (age >= 14) {
            System.out.printf("Если возраст ребенка равен %s, то ему кататься можно без сопровождения взрослого%n", age);
        } else if (age >= 5 && age < 14) {
            System.out.printf("Если возраст ребенка равен %s, то ему кататься можно с сопровождения взрослого%n", age);
        } else {
            System.out.printf("Если возраст ребенка равен %s, то ему нельзя кататься%n", age);
        }
        System.out.println("_________________________");
